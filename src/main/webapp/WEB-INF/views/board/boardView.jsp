...
<%@ include file="/WEB-INF/views/layout/subheader_support.jsp" %>
    <div class="container board board_header">
        <input type="hidden" id="boardTypeCd" name="boardTypeCd" value="D">
    ...
    <div class="main-contents">
        <div class="main-full board">
            ...
            <div class="prevNextBoard">
                ...
                <div class="board_icon_area"><a href="/board"><img src="/img/icon_list.png"></a></div>
            </div>
            
            <div class="box_support" data-aos="fade" data-aos-delay="400" data-aos-duration="1000" style="margin-bottom:120px;">
