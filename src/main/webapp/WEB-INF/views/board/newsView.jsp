...
<head>
    ...
    <section class="sub_header News">
        ...
        <div class="breadcrumb">
            <ul>
                ...
                <li id="bc-${board.categoryTypeNm}"><a style="color:white;" href="/news?openTabName=${board.categoryTypeNm}"><spring:message code="${board.categoryTypeNm}"/></a></li>
            </ul>
        </div>
    </section>
    <div class="product_view_wrapper">
        <section class="sub_header_under">
            <nav>
                <ul>
                    <li id="li-antenna"><a href="/news?openTabName=news"><spring:message code="News"/></a></li>
        ...
        <div class="main-contents">
            <div class="main-full board">
                ...
                <div class="prevNextBoard">
                    ...
                    <div class="board_icon_area"><a href="/news?openTabName=${board.categoryTypeEngNm}"><img src="/img/icon_list.png"></a></div>
                </div>
