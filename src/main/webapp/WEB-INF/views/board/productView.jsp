    ...
    <section class="subpage_header">
        <div class="breadcrumb">
            <ul>
                ...
                <li><a href="/product?openTabName=Inspection"><spring:message code="product"/></a></li>
                <li id="bc"><spring:message code="inspection"/></li>
            </ul>
        </div>
        <c:if test="${locale eq 'ko_KR' || locale eq 'ko'}">
            <h1 id="h1">${board.categoryTypeNm}</h1>
        </c:if>
        <c:if test="${locale eq 'en_US' || locale eq 'en'}">
            <h1 id="h1">${board.categoryTypeEngNm}</h1>
        </c:if>
        ...
        <div class="subpage_category">
            <button type="button" id="tab-Inspection" class="tab-link"  onclick="window.location.href='/product?openTabName=Inspection'"><spring:message code="inspection"/></button>
            <button type="button" id="tab-Analyzer" class="tab-link" onclick="window.location.href='/product?openTabName=Analyzer'"><spring:message code="analyzer"/></button>
            <button type="button" id="tab-Sensor" class="tab-link" onclick="window.location.href='/product?openTabName=Sensor'"><spring:message code="sensor"/></button>
            <button type="button" id="tab-Etc" class="tab-link" onclick="window.location.href='/product?openTabName=Etc'"><spring:message code="etc"/></button>
        </div>
    </section>
