          ...
          <ul>
              ...
              <li>
                 ...
                 <ul>
                     ...
                     <li><a href="/product?openTabName=Etc"><span><spring:message code="RF Modules"/></span></a></li>
                 </ul>
             </li>
              <li>
...
<div id="loader">
    ...
    width="60px" height="60px" viewBox="0 0 24 30" style="enable-background:new 0 0 50 50;" xml:space="preserve">
