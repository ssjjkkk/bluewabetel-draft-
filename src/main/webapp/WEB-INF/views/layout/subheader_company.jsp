...
<section class="sub_header">
    <h1 id="h1-company"><spring:message code="Company"/></h1>
    ...
    <div class="breadcrumb">
        <ul>
            ...
            <li id="bc-company" style="display:none;"><a style="color:white;" href="/company"><spring:message code="philosophy"/></a></li>
            <li id="bc-mission" style="display:none;"><a style="color:white;" href="/mission"><spring:message code="mission"/></a></li>
            ...
            <li id="bc-map" style="display:none;"><a style="color:white;" href="/map"><spring:message code="map"/></a></li>
        </ul>
    </div>
</section>
<section class="sub_header_under">
    <nav>
        <ul>
            ...
            <li id="mission"><a href="/mission"><spring:message code="Mission"/></a></li>
            <li id="vision"><a href="/vision"><spring:message code="Vision"/></a></li>
