...
<body>
    ...
    <section id="join_group">
        ...
        <form id="joinform" name="joinform" method="post" autocomplete="off">
            <h1 class="login_title">회원정보수정</h1>
            
            <input type="hidden" name="userUid" id="userUid" value="${user.userUid}"/>
            <input type="hidden" name="userTypeCd" id="userTypeCd" value="${user.userTypeCd}"/>
            <input type="hidden" name="delYn" id="delYn" value="${user.delYn}"/>
            <article class="join_wrap">
                
                <label class="input_box" for="userId">
                    <h3>아이디(이메일)</h3>
                    <input type="text" id="userId" name="userId" placeholder="이메일 주소를 입력하세요" value="${user.userId}" required="" disabled>
                    <%--
                    <!--
                    ...
                    <div class="confirm_message confirm_notice">Ⓥ 아이디 또는 패스워드 분실 시 이메일로 확인합니다.</div>
                </label>
                <!--
                ...
                <div class="input_box">
                    <h3>비밀번호 변경</h3>
                    <div id="pwModBtnArea"><input type="button" id="pwModBtn" style="cursor:pointer;" value="비밀번호 변경"></div>
                    <div class="password-wrap" style="display:none;">
                        <input type="password" name="userPw" id="userPw" size="20" maxlength="20" itemname="패스워드" placeholder="비밀번호를 입력하세요" value="" disabled>
                    </div>
                    
                    <h3 id="pwchkTitle" style="display:none;">비밀번호 확인</h3>
                    <div class="password-wrap" style="display:none;">
                        <input type="password" name="userpwchk" id="userpwchk" size="20" maxlength="20" itemname="비밀번호 확인" placeholder="비밀번호를 한번더 입력하세요" value="" disabled>
                    </div>
                ...
                <label class="input_box">
                    ...
                    <input type="text" name="userName" id="userName" itemname="이름" placeholder="공백 없이 한글, 영문, 숫자만 입력 가능" value="${user.userName}" >
                    <div id="namechk" class="confirm_message confirm_error"></div>
                </label>
        
                <label class="input_box">
                    <h3>별명</h3>
                    <input type="text" id="userNickName" name="userNickName" maxlength="9" placeholder="공백 없이 한글, 영문, 숫자만 입력 가능 (한글 2자, 영문 4자 이상 최대 8자)" value="${user.userNickName}">
            ...
            <div class="btn_box">
                ...
                <input type="button" id="logoutBtn" class="bigGrayBtn" value="로그아웃">
            </div>
        </form>
    </section>
